...
uint8 VDAC8_GYRO_initVar = 0;

#if (CY_PSOC5_ES1)
uint8 VDAC8_GYRO_restoreVal = 0;
uint8 VDAC8_GYRO_intrStatus = 0u;
#endif /* CY_PSOC5_ES1 */
...
void VDAC8_GYRO_Enable(void) 
{
    ...
    #if (CY_PSOC5_ES1)
    if ( VDAC8_GYRO_restoreVal == 1) 
    {
         VDAC8_GYRO_CR0 = VDAC8_GYRO_backup.data_value;
         VDAC8_GYRO_restoreVal = 0;
    }
    #endif
}
...
void VDAC8_GYRO_Start(void) 
{
    ...
    if ( VDAC8_GYRO_initVar == 0)  
    { 
        VDAC8_GYRO_Init();
       
        VDAC8_GYRO_initVar = 1;
    }
...
void VDAC8_GYRO_SetSpeed(uint8 speed) 
{
   ...
   VDAC8_GYRO_CR0 &= ~VDAC8_GYRO_HS_MASK ;    
...
{
   VDAC8_GYRO_CR0 &= ~VDAC8_GYRO_RANGE_MASK ;      /* Clear existing mode */
...
void VDAC8_GYRO_SetValue(uint8 value) 
{
   ...
   #if (CY_PSOC5_ES1)
       VDAC8_GYRO_intrStatus = CyEnterCriticalSection();
   #endif /* CY_PSOC5_ES1 */
...
void VDAC8_GYRO_DacTrim(void) 
{
    ...
    mode = ((VDAC8_GYRO_CR0 & VDAC8_GYRO_RANGE_MASK) >> 2) + VDAC8_GYRO_TRIM_M7_1V_RNG_OFFSET;
