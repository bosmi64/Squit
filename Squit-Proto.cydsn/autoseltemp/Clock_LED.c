...
{
    if (Clock_LED_CLKEN & Clock_LED_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Clock_LED_SetModeRegister(uint8 clkMode) 
{
    Clock_LED_MOD_SRC |= clkMode & Clock_LED_MODE_MASK;
}
...
*
*******************************************************************************/
void Clock_LED_ClearModeRegister(uint8 clkMode) 
{
    Clock_LED_MOD_SRC &= ~clkMode | ~Clock_LED_MODE_MASK;
}
...
{
    return Clock_LED_MOD_SRC & Clock_LED_MODE_MASK;
}
...
void Clock_LED_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Clock_LED_MOD_SRC |= CYCLK_SSS;
        Clock_LED_MOD_SRC =
            (Clock_LED_MOD_SRC & ~Clock_LED_SRC_SEL_MSK) | clkSource;
    }
