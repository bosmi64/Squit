...
void QuadDec_Cnt16_Init(void) 
{
            ...
            /* Clear the mode bits for continuous run mode */
                ...
                QuadDec_Cnt16_CONTROL2 &= ~QuadDec_Cnt16_CTRL_MODE_MASK;
            #endif
            #if (QuadDec_Cnt16_PSOC3_ES3 || QuadDec_Cnt16_PSOC5_ES2)
                QuadDec_Cnt16_CONTROL3 &= ~QuadDec_Cnt16_CTRL_MODE_MASK;                
            #endif
        ...
        QuadDec_Cnt16_SetInterruptMode(QuadDec_Cnt16_INIT_INTERRUPTS_MASK);
            ...
            QuadDec_Cnt16_ReadStatusRegister();
...
*
* Global variables:
*  QuadDec_Cnt16_initVar: Is modified when this function is called for the first 
...
uint16 QuadDec_Cnt16_ReadCounter(void) 
{
    ...
    CY_GET_REG8(QuadDec_Cnt16_COUNTER_LSB_PTR);
...
void QuadDec_Cnt16_SetCompareMode(uint8 compareMode) 
{
    ...
    QuadDec_Cnt16_CONTROL &= ~QuadDec_Cnt16_CTRL_CMPMODE_MASK;
    
    /* Write the new setting */
    QuadDec_Cnt16_CONTROL |= (compareMode << QuadDec_Cnt16_CTRL_CMPMODE0_SHIFT);
}
...
void QuadDec_Cnt16_SetCaptureMode(uint8 captureMode) 
{
    ...
    QuadDec_Cnt16_CONTROL &= ~QuadDec_Cnt16_CTRL_CAPMODE_MASK;
    
    /* Write the new setting */
    QuadDec_Cnt16_CONTROL |= (captureMode << QuadDec_Cnt16_CTRL_CAPMODE0_SHIFT);
}
...
void QuadDec_Cnt16_ClearFIFO(void) 
{
    ...
    while(QuadDec_Cnt16_ReadStatusRegister() & QuadDec_Cnt16_STATUS_FIFONEMP)
    {
        QuadDec_Cnt16_ReadCapture();
    }
