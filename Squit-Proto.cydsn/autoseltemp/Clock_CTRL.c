...
{
    if (Clock_CTRL_CLKEN & Clock_CTRL_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Clock_CTRL_SetModeRegister(uint8 clkMode) 
{
    Clock_CTRL_MOD_SRC |= clkMode & Clock_CTRL_MODE_MASK;
}
...
*
*******************************************************************************/
void Clock_CTRL_ClearModeRegister(uint8 clkMode) 
{
    Clock_CTRL_MOD_SRC &= ~clkMode | ~Clock_CTRL_MODE_MASK;
}
...
{
    return Clock_CTRL_MOD_SRC & Clock_CTRL_MODE_MASK;
}
...
void Clock_CTRL_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Clock_CTRL_MOD_SRC |= CYCLK_SSS;
        Clock_CTRL_MOD_SRC =
            (Clock_CTRL_MOD_SRC & ~Clock_CTRL_SRC_SEL_MSK) | clkSource;
    }
