...
#define `$INSTANCE_NAME`_BROADCAST_RATE `$BROADCAST_FREQ`
...
extern WORD `$INSTANCE_NAME`_serial_errors_count;                       
...
void `$INSTANCE_NAME`_GetProcessedData(UM7_PROCESSED_DATA *data);
