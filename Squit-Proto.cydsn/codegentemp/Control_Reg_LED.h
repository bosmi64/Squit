...
/* Control Register */
#define Control_Reg_LED_Control        (* (reg8 *) Control_Reg_LED_Sync_ctrl_reg__CONTROL_REG )
#define Control_Reg_LED_Control_PTR    (  (reg8 *) Control_Reg_LED_Sync_ctrl_reg__CONTROL_REG )
