...
void CHRUM7_CBUFFER_Init(void);           // La dimensione del buffer è nei parametri
...
BYTE CHRUM7_CBUFFER_GetByte(void);        // Preleva un byte dal buffer
...
WORD CHRUM7_CBUFFER_AnyData(void);        // Numero di byte nel buffer
...
BOOL CHRUM7_CBUFFER_ERROR(void);          // Errore di underflow o overflow
...
CBUFFER_STATUS CHRUM7_CBUFFER_Status(void);   // Vedi ME_lib_cbuffer.h per gli stati
