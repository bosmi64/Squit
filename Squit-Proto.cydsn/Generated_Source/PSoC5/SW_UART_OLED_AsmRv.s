;==============================================================================
; File Name: SW_UART_OLED_AsmRv.s
; Version 1.20
;
;  Description:
...
;==============================================================================
    ...
    IMPORT SW_UART_OLED_pinDrAdress
...
; void SW_UART_OLED_PutChar(uint8 txDataByte)
    ALIGN 8
SW_UART_OLED_PutChar FUNCTION
    EXPORT SW_UART_OLED_PutChar
SetPinMode
...
PORT_DR_ADDRESS DCD SW_UART_OLED_pinDrAdress
