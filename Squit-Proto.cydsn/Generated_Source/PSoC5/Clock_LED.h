...
#define Clock_LED_SetDivider(clkDivider)         Clock_LED_SetDividerRegister(clkDivider, 1u)
#define Clock_LED_SetDividerValue(clkDivider)    Clock_LED_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define Clock_LED_SetPhaseValue(clkPhase)        Clock_LED_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(Clock_LED__CFG3) */
