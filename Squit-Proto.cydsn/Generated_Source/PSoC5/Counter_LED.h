...
extern uint8 Counter_LED_initVar;
...
#define Counter_LED_GetInterruptSource() Counter_LED_ReadStatusRegister()
    ...
    void    Counter_LED_WriteControlRegister(uint8 control) \
        ;
#endif /* (!Counter_LED_ControlRegRemoved) */
#if (!(Counter_LED_UsingFixedFunction && (CY_PSOC5A)))
    void    Counter_LED_WriteCounter(uint8 counter) \
            ; 
#endif /* (!(Counter_LED_UsingFixedFunction && (CY_PSOC5A))) */
 ...
 **************************************/
#define Counter_LED_CAPTURE_MODE_CONF       0u
#define Counter_LED_INIT_PERIOD_VALUE       20u
#define Counter_LED_INIT_COUNTER_VALUE      20u
#if (Counter_LED_UsingFixedFunction)
#define Counter_LED_INIT_INTERRUPTS_MASK    ((uint8)((uint8)0u << Counter_LED_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define Counter_LED_INIT_COMPARE_VALUE      0u
#define Counter_LED_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_LED_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)0u << Counter_LED_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << Counter_LED_STATUS_CMP_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << Counter_LED_STATUS_OVERFLOW_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << Counter_LED_STATUS_UNDERFLOW_INT_EN_MASK_SHIFT)))
#define Counter_LED_DEFAULT_COMPARE_MODE    1u

#if( 0 != Counter_LED_CAPTURE_MODE_CONF)
    #define Counter_LED_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)0u << Counter_LED_CTRL_CAPMODE0_SHIFT))
#else    
    #define Counter_LED_DEFAULT_CAPTURE_MODE    (0u )
#endif /* ( 0 != Counter_LED_CAPTURE_MODE_CONF) */
 ...
 *************************************/
    ...
    #if (Counter_LED_Resolution <= 8u) /* 8-bit Counter */
    ...
    #elif(Counter_LED_Resolution <= 16u) /* 16-bit Counter */
        #if(CY_PSOC3) /* 8-bit address space */ 
            #define Counter_LED_STATICCOUNT_LSB     (*(reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__F0_REG )
            #define Counter_LED_STATICCOUNT_LSB_PTR ( (reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__F0_REG )
            #define Counter_LED_PERIOD_LSB          (*(reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__D0_REG )
            #define Counter_LED_PERIOD_LSB_PTR      ( (reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__D0_REG )
            #define Counter_LED_COMPARE_LSB         (*(reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__D1_REG )
            #define Counter_LED_COMPARE_LSB_PTR     ( (reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__D1_REG )
            #define Counter_LED_COUNTER_LSB         (*(reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__A0_REG )  
            #define Counter_LED_COUNTER_LSB_PTR     ( (reg16 *)\
                Counter_LED_CounterUDB_sC8_counterdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Counter_LED_STATICCOUNT_LSB     (*(reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__16BIT_F0_REG )
            #define Counter_LED_STATICCOUNT_LSB_PTR ( (reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__16BIT_F0_REG )
            #define Counter_LED_PERIOD_LSB          (*(reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__16BIT_D0_REG )
            #define Counter_LED_PERIOD_LSB_PTR      ( (reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__16BIT_D0_REG )
            #define Counter_LED_COMPARE_LSB         (*(reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__16BIT_D1_REG )
            #define Counter_LED_COMPARE_LSB_PTR     ( (reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__16BIT_D1_REG )
            #define Counter_LED_COUNTER_LSB         (*(reg16 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__16BIT_A0_REG )  
            #define Counter_LED_COUNTER_LSB_PTR     ( (reg16 *)\
                Counter_LED_CounterUDB_sC8_counterdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */   
    #elif(Counter_LED_Resolution <= 24u) /* 24-bit Counter */
        
        #define Counter_LED_STATICCOUNT_LSB     (*(reg32 *) \
            Counter_LED_CounterUDB_sC8_counterdp_u0__F0_REG )
        #define Counter_LED_STATICCOUNT_LSB_PTR ( (reg32 *) \
            Counter_LED_CounterUDB_sC8_counterdp_u0__F0_REG )
        #define Counter_LED_PERIOD_LSB          (*(reg32 *) \
            Counter_LED_CounterUDB_sC8_counterdp_u0__D0_REG )
        #define Counter_LED_PERIOD_LSB_PTR      ( (reg32 *) \
            Counter_LED_CounterUDB_sC8_counterdp_u0__D0_REG )
        #define Counter_LED_COMPARE_LSB         (*(reg32 *) \
            Counter_LED_CounterUDB_sC8_counterdp_u0__D1_REG )
        #define Counter_LED_COMPARE_LSB_PTR     ( (reg32 *) \
            Counter_LED_CounterUDB_sC8_counterdp_u0__D1_REG )
        #define Counter_LED_COUNTER_LSB         (*(reg32 *) \
            Counter_LED_CounterUDB_sC8_counterdp_u0__A0_REG )  
        #define Counter_LED_COUNTER_LSB_PTR     ( (reg32 *)\
            Counter_LED_CounterUDB_sC8_counterdp_u0__A0_REG )
            ...
            #define Counter_LED_STATICCOUNT_LSB     (*(reg32 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__32BIT_F0_REG )
            #define Counter_LED_STATICCOUNT_LSB_PTR ( (reg32 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__32BIT_F0_REG )
            #define Counter_LED_PERIOD_LSB          (*(reg32 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__32BIT_D0_REG )
            #define Counter_LED_PERIOD_LSB_PTR      ( (reg32 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__32BIT_D0_REG )
            #define Counter_LED_COMPARE_LSB         (*(reg32 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__32BIT_D1_REG )
            #define Counter_LED_COMPARE_LSB_PTR     ( (reg32 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__32BIT_D1_REG )
            #define Counter_LED_COUNTER_LSB         (*(reg32 *) \
                Counter_LED_CounterUDB_sC8_counterdp_u0__32BIT_A0_REG )  
            #define Counter_LED_COUNTER_LSB_PTR     ( (reg32 *)\
                Counter_LED_CounterUDB_sC8_counterdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */   
    #endif

	#define Counter_LED_COUNTER_LSB_PTR_8BIT     ( (reg8 *)\
                Counter_LED_CounterUDB_sC8_counterdp_u0__A0_REG )
    ...
    #define Counter_LED_AUX_CONTROLDP0_PTR \
       ...
       #define Counter_LED_AUX_CONTROLDP1_PTR \
           ( (reg8 *) Counter_LED_CounterUDB_sC8_counterdp_u1__DP_AUX_CTL_REG)
    #endif /* (Counter_LED_Resolution == 16 || Counter_LED_Resolution == 24 || Counter_LED_Resolution == 32) */
       ...
       #define Counter_LED_AUX_CONTROLDP2_PTR \
           ( (reg8 *) Counter_LED_CounterUDB_sC8_counterdp_u2__DP_AUX_CTL_REG)
    #endif /* (Counter_LED_Resolution == 24 || Counter_LED_Resolution == 32) */
       ...
       #define Counter_LED_AUX_CONTROLDP3_PTR \
           ( (reg8 *) Counter_LED_CounterUDB_sC8_counterdp_u3__DP_AUX_CTL_REG)
    #endif /* (Counter_LED_Resolution == 32) */
    ...
    ********************************/
    ...
    #define Counter_LED_CTRL_ENABLE            ((uint8)((uint8)0x01u << Counter_LED_CTRL_ENABLE_SHIFT))         
    #define Counter_LED_ONESHOT                ((uint8)((uint8)0x01u << Counter_LED_ONESHOT_SHIFT))
    ...
    /* Set the mask for run mode */
        ...
        #define Counter_LED_CTRL_MODE_MASK         ((uint8)((uint8)0x07u << Counter_LED_CTRL_MODE_SHIFT))
    #endif /* (CY_PSOC5A) */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Use CFG2 Mode bits to set run mode */
        #define Counter_LED_CTRL_MODE_SHIFT        0x00u    
        #define Counter_LED_CTRL_MODE_MASK         ((uint8)((uint8)0x03u << Counter_LED_CTRL_MODE_SHIFT))
    #endif /* (CY_PSOC3 || CY_PSOC5LP) */
    /* Set the mask for interrupt (raw/status register) */
    #define Counter_LED_CTRL2_IRQ_SEL_SHIFT     0x00u
    #define Counter_LED_CTRL2_IRQ_SEL          ((uint8)((uint8)0x01u << Counter_LED_CTRL2_IRQ_SEL_SHIFT))     
    ...
    #define Counter_LED_STATUS_ZERO            ((uint8)((uint8)0x01u << Counter_LED_STATUS_ZERO_SHIFT))

    /* Status Register Interrupt Bit Masks*/
    #define Counter_LED_STATUS_ZERO_INT_EN_MASK       ((uint8)((uint8)Counter_LED_STATUS_ZERO >> 0x04u))
    
    /*RT1 Synch Constants: Applicable for PSoC3 and PSoC5LP */
    #define Counter_LED_RT1_SHIFT            0x04u
    #define Counter_LED_RT1_MASK             ((uint8)((uint8)0x03u << Counter_LED_RT1_SHIFT))  /* Sync TC and CMP bit masks */
    #define Counter_LED_SYNC                 ((uint8)((uint8)0x03u << Counter_LED_RT1_SHIFT))
    #define Counter_LED_SYNCDSI_SHIFT        0x00u
    #define Counter_LED_SYNCDSI_MASK         ((uint8)((uint8)0x0Fu << Counter_LED_SYNCDSI_SHIFT)) /* Sync all DSI inputs */
    #define Counter_LED_SYNCDSI_EN           ((uint8)((uint8)0x0Fu << Counter_LED_SYNCDSI_SHIFT)) /* Sync all DSI inputs */
    ...
    ********************************/
    ...
    /* Control Register Bit Masks */
    #define Counter_LED_CTRL_CMPMODE_MASK      0x07u 
    #define Counter_LED_CTRL_CAPMODE_MASK      0x03u  
    #define Counter_LED_CTRL_RESET             ((uint8)((uint8)0x01u << Counter_LED_CTRL_RESET_SHIFT))  
    #define Counter_LED_CTRL_ENABLE            ((uint8)((uint8)0x01u << Counter_LED_CTRL_ENABLE_SHIFT)) 
    ...
    /* Status Register Bit Masks */                
    #define Counter_LED_STATUS_CMP             ((uint8)((uint8)0x01u << Counter_LED_STATUS_CMP_SHIFT))  
    #define Counter_LED_STATUS_ZERO            ((uint8)((uint8)0x01u << Counter_LED_STATUS_ZERO_SHIFT)) 
    #define Counter_LED_STATUS_OVERFLOW        ((uint8)((uint8)0x01u << Counter_LED_STATUS_OVERFLOW_SHIFT)) 
    #define Counter_LED_STATUS_UNDERFLOW       ((uint8)((uint8)0x01u << Counter_LED_STATUS_UNDERFLOW_SHIFT)) 
    #define Counter_LED_STATUS_CAPTURE         ((uint8)((uint8)0x01u << Counter_LED_STATUS_CAPTURE_SHIFT)) 
    #define Counter_LED_STATUS_FIFOFULL        ((uint8)((uint8)0x01u << Counter_LED_STATUS_FIFOFULL_SHIFT))
    #define Counter_LED_STATUS_FIFONEMP        ((uint8)((uint8)0x01u << Counter_LED_STATUS_FIFONEMP_SHIFT))
