...
extern uint8 VDAC8_GYRO_initVar;
...
***************************************/
 ...
 /* Default DAC range */
#define VDAC8_GYRO_DEFAULT_RANGE    4u
 /* Default DAC speed */
#define VDAC8_GYRO_DEFAULT_SPEED    2u
 /* Default Control */
#define VDAC8_GYRO_DEFAULT_CNTL      0x00u
/* Default Strobe mode */
#define VDAC8_GYRO_DEFAULT_STRB     0u
 /* Initial DAC value */
#define VDAC8_GYRO_DEFAULT_DATA     100u
 /* Default Data Source */
#define VDAC8_GYRO_DEFAULT_DATA_SRC 0u


/***************************************
*              Registers        
***************************************/
#define VDAC8_GYRO_CR0_REG            (* (reg8 *) VDAC8_GYRO_viDAC8__CR0 )
#define VDAC8_GYRO_CR0_PTR            (  (reg8 *) VDAC8_GYRO_viDAC8__CR0 )
#define VDAC8_GYRO_CR1_REG            (* (reg8 *) VDAC8_GYRO_viDAC8__CR1 )
#define VDAC8_GYRO_CR1_PTR            (  (reg8 *) VDAC8_GYRO_viDAC8__CR1 )
#define VDAC8_GYRO_Data_REG           (* (reg8 *) VDAC8_GYRO_viDAC8__D )
#define VDAC8_GYRO_Data_PTR           (  (reg8 *) VDAC8_GYRO_viDAC8__D )
#define VDAC8_GYRO_Strobe_REG         (* (reg8 *) VDAC8_GYRO_viDAC8__STROBE )
#define VDAC8_GYRO_Strobe_PTR         (  (reg8 *) VDAC8_GYRO_viDAC8__STROBE )
#define VDAC8_GYRO_SW0_REG            (* (reg8 *) VDAC8_GYRO_viDAC8__SW0 )
#define VDAC8_GYRO_SW0_PTR            (  (reg8 *) VDAC8_GYRO_viDAC8__SW0 )
#define VDAC8_GYRO_SW2_REG            (* (reg8 *) VDAC8_GYRO_viDAC8__SW2 )
#define VDAC8_GYRO_SW2_PTR            (  (reg8 *) VDAC8_GYRO_viDAC8__SW2 )
#define VDAC8_GYRO_SW3_REG            (* (reg8 *) VDAC8_GYRO_viDAC8__SW3 )
#define VDAC8_GYRO_SW3_PTR            (  (reg8 *) VDAC8_GYRO_viDAC8__SW3 )
#define VDAC8_GYRO_SW4_REG            (* (reg8 *) VDAC8_GYRO_viDAC8__SW4 )
#define VDAC8_GYRO_SW4_PTR            (  (reg8 *) VDAC8_GYRO_viDAC8__SW4 )
#define VDAC8_GYRO_TR_REG             (* (reg8 *) VDAC8_GYRO_viDAC8__TR )
#define VDAC8_GYRO_TR_PTR             (  (reg8 *) VDAC8_GYRO_viDAC8__TR )
/* Power manager */
#define VDAC8_GYRO_PWRMGR_REG         (* (reg8 *) VDAC8_GYRO_viDAC8__PM_ACT_CFG )
#define VDAC8_GYRO_PWRMGR_PTR         (  (reg8 *) VDAC8_GYRO_viDAC8__PM_ACT_CFG )
  /* Standby Power manager */
#define VDAC8_GYRO_STBY_PWRMGR_REG    (* (reg8 *) VDAC8_GYRO_viDAC8__PM_STBY_CFG )
#define VDAC8_GYRO_STBY_PWRMGR_PTR    (  (reg8 *) VDAC8_GYRO_viDAC8__PM_STBY_CFG )
