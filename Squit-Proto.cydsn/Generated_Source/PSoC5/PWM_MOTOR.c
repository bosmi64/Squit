...
void PWM_MOTOR_Init(void) 
{
        ...
        ctrl = PWM_MOTOR_CONTROL & ((uint8)(~PWM_MOTOR_CTRL_CMPMODE2_MASK)) & ((uint8)(~PWM_MOTOR_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void PWM_MOTOR_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        PWM_MOTOR_CONTROL &= ((uint8)(~(PWM_MOTOR_CTRL_CMPMODE1_MASK | PWM_MOTOR_CTRL_CMPMODE2_MASK))); 
...
void PWM_MOTOR_WritePeriod(uint16 period) 
{
    ...
    *******************************************************************************/
    uint8 PWM_MOTOR_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(PWM_MOTOR_STATUS_PTR);
    	return (result);
    }
