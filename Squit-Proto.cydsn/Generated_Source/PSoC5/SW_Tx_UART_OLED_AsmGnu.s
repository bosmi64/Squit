/******************************************************************************
* File Name: SW_Tx_UART_OLED_AsmGnu.s
* Version 1.20
*
*  Description:
...
/******************************************************************************
* Function Name: SW_Tx_UART_OLED_PutChar
*******************************************************************************
*
* Summary:
...
.global SW_Tx_UART_OLED_PutChar
.func SW_Tx_UART_OLED_PutChar, SW_Tx_UART_OLED_PutChar
.type SW_Tx_UART_OLED_PutChar, %function
.thumb_func
SW_Tx_UART_OLED_PutChar:
SetPinMode:
...
bitTxLoop:
    ...
    .align 3
PORT_DR_ADDRESS:
    .word SW_Tx_UART_OLED_pinDrAdress
FREQ:
