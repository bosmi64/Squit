...
{
    uint8 staticBits = (LED_OK_DR & (uint8)(~LED_OK_MASK));
    LED_OK_DR = staticBits | ((uint8)(value << LED_OK_SHIFT) & LED_OK_MASK);
}
...
*
*  LED_OK_DM_STRONG     Strong Drive 
*  LED_OK_DM_OD_HI      Open Drain, Drives High 
*  LED_OK_DM_OD_LO      Open Drain, Drives Low 
*  LED_OK_DM_RES_UP     Resistive Pull Up 
*  LED_OK_DM_RES_DWN    Resistive Pull Down 
*  LED_OK_DM_RES_UPDWN  Resistive Pull Up/Down 
*  LED_OK_DM_DIG_HIZ    High Impedance Digital 
*  LED_OK_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
