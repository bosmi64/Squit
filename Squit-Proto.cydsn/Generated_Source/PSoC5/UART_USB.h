...
#define UART_USB_USE23POLLING                   (0u)
#define UART_USB_FLOW_CONTROL                   (0u)
#define UART_USB_CLK_FREQ                       (0u)
#define UART_USB_TXBUFFERSIZE                   (4u)
#define UART_USB_RXBUFFERSIZE                   (4u)
...
extern uint8 UART_USB_initVar;
    ...
    extern volatile uint8 UART_USB_txBuffer[UART_USB_TXBUFFERSIZE];
    extern volatile uint8 UART_USB_txBufferRead;
    extern uint8 UART_USB_txBufferWrite;
#endif /* End UART_USB_TX_ENABLED */
#if( ( UART_USB_RX_ENABLED || UART_USB_HD_ENABLED ) && \
     (UART_USB_RXBUFFERSIZE > UART_USB_FIFO_LENGTH) )
    extern volatile uint8 UART_USB_rxBuffer[UART_USB_RXBUFFERSIZE];
